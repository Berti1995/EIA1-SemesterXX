...
let todoInterFace: InterfaceListe[] = [
    {
        content: "Lorem",
        checked: true
    },
...
function drawListToDOM(): void {
    ...
    for (let index: number = 0; index < todoInterFace.length; index++) {
         ...
         */
        todo.innerHTML =  "<span class='check " + todoInterFace[index].checked + "'><i class='fas fa-check'></i></span>"
                            + todoInterFace[index].content +
...
function toggleCheckState(index: number): void {
     ...
     */
    todoInterFace [index].checked = !todoInterFace[index]. checked;
